...
@section('content-title', 'User Managemen')

@section('breadcrumb')
<ol class="breadcrumb float-sm-right">
  <li class="breadcrumb-item"><a href="{{ Route('index.user') }}">User Managemen</a></li>
</ol>
@endsection
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        ...
        <a class="btn btn-primary btn-sm float-right" href="{{ url('master/users/new') }}"><i class="fa fa-plus"></i> Add New</a>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{ url('master/users/edit/'.$user->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                <button class="btn btn-default btn-sm" onClick="showDetailModal(this)" data-user="{{ $user }}"><i class="fa fa-eye"></i></button>&nbsp;&nbsp;
                <a href="{{ url('master/users/delete/'.$user->id) }}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
              </td>
            </tr>
            @endforeach
          </tbody>
