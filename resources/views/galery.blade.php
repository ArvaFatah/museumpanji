<html lang="zxx" class="no-js">
	<head>
		...
		<link href="https://fonts.googleapis.com/css?family=Poppins:100,200,400,300,500,600,700" rel="stylesheet"> 
			...
			CSS
			============================================= -->
			<link rel="stylesheet" href="{{ asset('assets/custom/js/linearicons.css') }}">
			<link rel="stylesheet" href="{{ asset('assets/custom/js/font-awesome.min.css') }}">
			<link rel="stylesheet" href="{{ asset('assets/custom/js/bootstrap.css') }}">
			<link rel="stylesheet" href="{{ asset('assets/custom/js/magnific-popup.css') }}">
			<link rel="stylesheet" href="{{ asset('assets/custom/js/nice-select.css') }}">					
			<link rel="stylesheet" href="{{ asset('assets/custom/js/animate.min.css') }}">
			<link rel="stylesheet" href="{{ asset('assets/custom/js/owl.carousel.css') }}">
			<link rel="stylesheet" href="{{ asset('assets/custom/js/main.css') }}">
		</head>
		<body>
			  	...
			  	<div class="container header-top">
			  		<div class="row">
				  		<div class="col-6 top-head-left">
				  			<ul>
				  				<li><a href="{{ url('/home') }}"><img src="{{asset('assets/image/logo.png')}}" width="30%" alt="" title="" /></a></li>
				  			</ul>
				  		</div>
			    	...
			    	<div class="row align-items-center justify-content-between d-flex">
				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li><a href="{{ url('/profil') }}">Contact</a></li>
			...
			<section class="gallery-area section-gap gallery-page-area" id="gallery">
				<div class="container">
					...
					<div id="grid-container" class="row">
						<a class="single-gallery" href="{{asset('assets/image/candi.jpg')}}"><img class="grid-item" src="{{asset('assets/image/candi.jpg')}}"></a>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
			...
			<script src="{{ asset('assets/custom/jquery-2.2.4.min.js') }}"></script>
			<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
			<script src="{{ asset('assets/custom/bootstrap.min.js') }}"></script>			
			<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
  			<script src="{{ asset('assets/custom/easing.min.js') }}"></script>			
			<script src="{{ asset('assets/custom/hoverIntent.js') }}"></script>
			<script src="{{ asset('assets/custom/superfish.min.js') }}"></script>	
			<script src="{{ asset('assets/custom/jquery.ajaxchimp.min.js') }}"></script>
			<script src="{{ asset('assets/custom/jquery.magnific-popup.min.js') }}"></script>	
			<script src="{{ asset('assets/custom/owl.carousel.min.js') }}"></script>	
			<script src="{{ asset('assets/custom/imagesloaded.pkgd.min.js') }}"></script>
			<script src="{{ asset('assets/custom/justified.min.js') }}"></script>					
			<script src="{{ asset('assets/custom/jquery.sticky.js') }}"></script>
			<script src="{{ asset('assets/custom/jquery.nice-select.min.js') }}"></script>			
			<script src="{{ asset('assets/custom/parallax.min.js') }}"></script>		
			<script src="{{ asset('assets/custom/mail-script.js') }}"></script>	
